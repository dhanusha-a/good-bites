<?php
 ...
 if($_POST['submit'])
 {
	      $query="select * from admin where admin_name='$admin_name' and password= '$pass'";
        ...
        <div class="col col_2">        	
			...
			<br><br><br><br><br>
                ...
                <form method="post" name="login" action="#">
                    <label for="username">Admin name:</label> <input type="text" id="admin_name" name="admin_name" class="input_field" value="<?php echo $admin_name; ?>"/><br>
